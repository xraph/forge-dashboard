...
/**
 * The plugin that ships. It is built on the same `definePlugin` a third
 * party uses -- the spec's most important structural claim, because an
 * extension point the authors do not use themselves is one they will ship
